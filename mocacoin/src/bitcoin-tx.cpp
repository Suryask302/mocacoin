...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mocacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mocacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mocacoin transaction") + "\n" +
              "  mocacoin-tx [options] -create [commands]   " + _("Create hex-encoded mocacoin transaction") + "\n" +
              "\n";
