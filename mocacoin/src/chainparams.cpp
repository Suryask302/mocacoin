...
{
    const char* pszTimestamp = "This is my new mocacoin in 2022";
    const CScript genesisOutputScript = CScript() << ParseHex("099184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1660814091, 2001466072, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe39dd42d1a9c386a99a5376cc406acb4b3d607c87c44378fb8c1138415b7ebe3"));
        assert(genesis.hashMerkleRoot == uint256S("0x7dbba1a09a6991695dbd51e4331920eb936a9de01bcbf71fb2917b870bef9deb"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("198.211.98.221", "198.211.98.221", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("mocacointools.com", "dnsseed.mocacointools.com"));
        //vSeeds.push_back(CDNSSeedData("mocacoinpool.org", "dnsseed.mocacoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xe39dd42d1a9c386a99a5376cc406acb4b3d607c87c44378fb8c1138415b7ebe3"))
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1660814091, 421233, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x60e82fd46f0f05f7896e1aef6053c4ee907cac93328c0bd1381c8a8017f7798b"));
        assert(genesis.hashMerkleRoot == uint256S("0x7dbba1a09a6991695dbd51e4331920eb936a9de01bcbf71fb2917b870bef9deb"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("198.211.98.221", "198.211.98.221"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.mocacoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x60e82fd46f0f05f7896e1aef6053c4ee907cac93328c0bd1381c8a8017f7798b")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1660814091, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1639449c43b987090f6928005ae1442f1126d36e14851126d717bcdf0e20ed51"));
        assert(genesis.hashMerkleRoot == uint256S("0x7dbba1a09a6991695dbd51e4331920eb936a9de01bcbf71fb2917b870bef9deb"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x1639449c43b987090f6928005ae1442f1126d36e14851126d717bcdf0e20ed51"))
        };
