...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/mocacoin-project/mocacoin>";
    const std::string URL_WEBSITE = "<https://mocacoin.org>";
