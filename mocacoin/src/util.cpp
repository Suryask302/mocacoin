...
const char * const BITCOIN_CONF_FILENAME = "mocacoin.conf";
const char * const BITCOIN_PID_FILENAME = "mocacoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Mocacoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Mocacoin";
#else
    // Unix
    return pathRet / ".mocacoin";
#endif
#endif
}
